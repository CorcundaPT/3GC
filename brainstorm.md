...
It will contain 3 Action Economy, 3 Main Attributes, multiple skills, and multiple Glyphs and Talents to personalise the character. Glyphs are a passive the character has and can be swapped after a rest, while Talents will give bonus and ability, creating different actions. Every level a character receives 1 Talent Point to spend on Talents.

Talents can increase Attributes, Defenses, bonus, damage, or even unlock new abilities to use on adventures.

Spellcasting is customizable making the spellcaster use their imagination to create spells. There will be tomes that contain spells on it, to help imagination on the player, or to help the caster casting the spell reducing the penalty of casting upscaled spells.

There will be four types of Fatigue being Exhaust for Body and Block, Dazed for Mind and Dodge, Scared for Soul and Ward and Mana for casting spells. The players can induce one of the Fatigues, not including Mana, on self to restore Health or recover from Mana Fatigue.
...
| | If the target is attacked with a Freeze stack, the target takes an extra 5 Cryo Damage.


*Electro*
| - Shock (passive): No Shock stack (+1 Shock / Mana)
| | If a shocked creature ends its turn adjacent to other shocked creatures, both take damage equal to both creatures stacks combined.
| | After resolution reduce Shock stacks by 1.
|
| - Conduction (active): [Area: Line; Range]
| | Create a connection between any amount of shocked creatures.
| | Any creature connected takes Electro damage equal to all creature Shock stacks combined.
| | After Conduction resolution, all targets lose their Shock stacks.
...
*Hydromancy*
| - Cleanse (passive): No cleanse stacks (+1 stacks / Mana)
| | Reduce one Buff of Debuff by 1 of the target creature.
|
| - Absorption (active): [Absorption; Area: Any; Duration; Range]; No Absorption (+1 Absorption / Mana)
| | Creature an water bubble area that absorbs any spell passing through it.
| | The bubble can only absorb spells with a power below the Absorption remains.
| | Any absorption remaining can be drained, restoring the caster's Mana.


*Pyromancy*
| - Burn (passive): No Burn stack (+1 Burn / Mana)
| | At the end of the burned creature's turn, the creature takes Pyro damage equal to the amount of Burn stacks.
| | After resolution reduce Burn stacks by 1.
|
| - Explosion (active): [Area: Radius; Range]
| | Concentrate on a creature with Burn stacks and make it explode.
| | The exploding creature takes Pyro damage equal to the amount of Burn stacks and aplly them to all creatures within the Area.
| | If the Explosion has no Area, it implodes and deals twice the Pyro damage to the target.
| | After Explosion is resolved, the target loses all Burn stacks.
...
Magic Properties
- Elemental (FIre, Ice, Water, Earth, Lightning, Wind)
- Divine
- Arcana
- Mental?
- Necromancy
...
- Echantment (Influence)
- Evocation (Damage)
- Ilusion (Sight and Sound)
- Transmutation (Change Properties)

\\
Pyro + Conjuration
- Summon a wisp of fire that eminate light from it's body.
- This wisp can shoot bolts of fire dealing damage and burn stacks associated with the spell.
//

\\
Pyro + Divination
- A trail of ember follow a target within range.
//

\\
*Goblin*
HP:3 | Always Dodge
Body: 10 | Mind: 5 | Soul : 8
Dodge: +2 | Block: -1 | Ward: -2
Dagger: Physical Melee, Stab 1, Wound 1
Sling: Physical Ranged, Blunt 1
---
Stab- stab damage.
Blunt- blunt damage.
Wound- decrease target Dodge by 1 until the target finish a rest.
Treat wound(medicine)- decrease the number of Wound stack by 1.
//
...
\\
Dual Wielding- You can Dual Wield any weapon but if the weapon doesn't have the Light tag, the attack has a penalty of 5.

Heavy- This weapons must be used with two hands otherwise, the attack has a penalty of 5.

Wound- A creature with a Wound as the Dodge defense reduced by 1 until the target finish a rest or spend some time to Treat Wounds.
//
